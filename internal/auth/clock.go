...
// sleepCtx sleeps for d or until ctx is cancelled, whichever comes first. It is
// a package variable so device-code polling tests can run without real delays.
